...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/seller-pnl',   label: 'Seller P&L',    icon: SellerPnLIcon },
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/branch-report',     label: 'Branch Report',    icon: BranchIcon },
      { to: '/branch-management', label: 'Branch Setup',     icon: BranchSettingsIcon },
...
function BranchSettingsIcon({ className }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
